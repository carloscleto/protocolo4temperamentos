...
const faqs = [
  ...
  { q: "E se meu filho for mistura de temperamentos?", a: "Normal. Use o Guia de Sobrevivência dos 4 Temperamentos. Combine as técnicas. Teste e ajuste conforme a reação dele." },
