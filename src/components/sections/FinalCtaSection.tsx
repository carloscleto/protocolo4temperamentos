    ...
    <div className="max-w-6xl mx-auto flex flex-col gap-6">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-xl mx-auto">
          <CtaButton text="CHEGA DE GRITOS" href="https://pay.cakto.com.br/3d2bb4x_811174" extraClasses="shadow-2xl" onClick={() => { if (typeof window !== 'undefined' && window.gtag) { window.gtag('event', 'cta_click', { event_category: 'conversao', event_label: 'final_quero_meu_acesso' }); } }} />
        </div>
