...
const lessons = [
  { title: "Aula 1 : Fundamentos", desc: "Entenda seu filho em minutos e reduza brigas hoje.", color: "rgb(10, 104, 255)", Icon: BookOpen, bgClass: "bg-digitalBlue" },
  { title: "Aula 2 : Colérico Sem Embate", desc: "Acabe com disputas de poder em 5 minutos, sem gritar.", color: "rgb(255, 87, 51)", Icon: Flame, bgClass: "bg-choleric" },
  { title: "Aula 3 : Sanguíneo Com Foco", desc: "Torne tarefas um jogo e acelere a sua manhã.", color: "rgb(255, 193, 7)", Icon: Wind, bgClass: "bg-sanguine" },
  ...
  <section className="w-full px-4 py-16 md:py-20 bg-prussianBlueDark text-cornSilk md:!pt-16 !pb-20">
    <div className="max-w-6xl mx-auto flex flex-col gap-6">
      ...
      <div className="space-y-4 self-center">
        ...
        <div className="pt-6">
          <div className="inline-block bg-pumpkinSpice text-seaShell px-4 py-1 rounded-full text-base font-bold mb-4">🎁 2 BÔNUS EXCLUSIVOS</div>
